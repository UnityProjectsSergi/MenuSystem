...
public class GameController : MonoBehaviour
{
    ...
    public static string _datapPathListUsers;
    ...
    private void Awake()
    {
        ...
        else
        {
            ...
            {
                datapath = globalSettignsMenuSC.saveSystemSettings.SaveLocalSystem.InitParthsData();
                dataExists = File.Exists(datapath);
                _datapPathListUsers = globalSettignsMenuSC.saveSystemSettings.SaveLocalSystem.InitUserListDataPath();
            }
            ...
            LoadData();*/
            InitGameSettingsLoad();
        }
    }

    public void InitGameSettingsLoad()
    {
        if (globalSettignsMenuSC.saveSystemSettings.saveSourceData == SaveSystemSourceData.Local)
        {
            datapath = globalSettignsMenuSC.saveSystemSettings.SaveLocalSystem.InitParthsData();
    ...
    {
        ObjToSave obj = CreateGameObject(Resources.Load<GameObject>(data.prefabPath), data.position, data.rotation);
    ...
    public static void SaveGame()
    {
        ...
        else
        {
            ...
            SaveData.SaveToFile(_datapPathListUsers,SaveData.usersList,true);
        }
    }
