...
[CustomEditor(typeof(bl_SceneLoaderSergi))]
public class bl_SceneLoaderEditorSergi : Editor
{
    private bl_SceneLoaderSergi Script;

    private void OnEnable()
    {
        Script = (bl_SceneLoaderSergi)target;
    }

    public override void OnInspectorGUI()
    {
       if(Script == null) { Script = (bl_SceneLoaderSergi)target; }
        ...
        if (Script._showReferences)
        {
            ...
            Script.ContinueBTN = EditorGUILayout.ObjectField("ContinueBtn", Script.ContinueBTN, typeof(Button), true) as Button;
